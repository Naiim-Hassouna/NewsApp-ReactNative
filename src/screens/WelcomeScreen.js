...
export default function Welcome() {
  ...
  return (
    <ImageBackground
      source={require("../../assets/images/welcome/breakingnews.jpg")}
    ...
    >
      ...
      <View className="flex-1 items-center justify-end max-w-[85%]  space-y-4 ">
        ...
        >
          Discover the Latest News with our Live Application.
        </Text>
      </View>
      ...
      >
        <Text className="text-base text-blue-900 ">Getting Started</Text>
      </TouchableOpacity>
    </ImageBackground>
  );
}
